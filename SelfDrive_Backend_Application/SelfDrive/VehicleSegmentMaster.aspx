<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="VehicleSegmentMaster.aspx.cs" Inherits="SelfDrive.VehicleSegmentMaster" EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script lang="javascript" type="text/javascript">
        function SaveValidation() {
            ...
            if (document.getElementById("<%= txtvehiclesegname.ClientID %>").value == "") {
                document.getElementById("<%= txtvehiclesegname.ClientID %>").style.borderColor = "Red";
                errmsg += "";
                flag = false;
            }
            else {

                document.getElementById("<%= txtvehiclesegname.ClientID %>").style.borderColor = "#ccc";
            }
    ...
    <script lang="javascript" type="text/javascript">
        function NewUserProfile() {
            ...
            document.getElementById("<%= txtvehiclesegname.ClientID %>").value = '';
    ...
    <script lang="javascript" type="text/javascript">
        ...
        function FillDetails(vehsegid, vehsegname, status, companyId) {
        
           
            document.getElementById("<%= huserprofile.ClientID %>").value = vehsegid;
            document.getElementById("<%= txtvehiclesegname.ClientID %>").value = vehsegname;
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-content modal-heading">
                    ...
                    <h4 class="modal-title" id="myModelLabel">&nbsp; Vehicle Segment Info</h4>
                </div>
                <div class="modal-body">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <h5 style="color: #2196f3;display:none;">Vehicle Segment Info</h5>
                        <div class="row">
                                    ...
                                    <div class="col-md-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <label >Name</label>
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                            <asp:TextBox runat="server" ID="txtvehiclesegname" CssClass="form-control form-control1" autocomplete="off"></asp:TextBox>
                                                    </div>
