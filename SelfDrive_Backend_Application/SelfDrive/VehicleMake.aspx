<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="VehicleMake.aspx.cs" Inherits="SelfDrive.VehicleMake"   EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script lang="javascript" type="text/javascript">
        function SaveValidation() {
            ...
            if (document.getElementById("<%= txtvehmakename.ClientID %>").value == "") {
                document.getElementById("<%= txtvehmakename.ClientID %>").style.borderColor = "Red";
                errmsg += "";
                flag = false;
            }
            else {

                document.getElementById("<%= txtvehmakename.ClientID %>").style.borderColor = "#ccc";
            }

            if (document.getElementById("<%= ddlVehicles.ClientID %>").value == "Select") {
                document.getElementById("<%= ddlVehicles.ClientID %>").style.borderColor = "Red";
                errmsg += "";
                flag = false;
            }
            else {
                document.getElementById("<%= ddlVehicles.ClientID %>").style.borderColor = "#ccc";
            }
    ...
    <script lang="javascript" type="text/javascript">
        function NewUserProfile() {
            ...
            document.getElementById("<%= txtvehmakename.ClientID %>").value = '';
    ...
    <script lang="javascript" type="text/javascript">
        ...
        function FillDetails(vehmakeid, vehmake, status, acnonac, vehsegids, companyId) {
        
           
            document.getElementById("<%= huserprofile.ClientID %>").value = accsid;
            document.getElementById("<%= txtvehmakename.ClientID %>").value = accsname;
            
            var AcNonAc = document.getElementById("<%=ddlAcNonAc.ClientID %>");
            for (var i = 0; i < AcNonAc.options.length; i++) {
                if (AcNonAc.options[i].text === acnonac) {
                    AcNonAc.selectedIndex = i;
                    break;
                }
            }
            ...
            var vehseg = document.getElementById("<%=ddlVehicles.ClientID %>");
            for (var i = 0; i < vehseg.options.length; i++) {
                if (vehseg.options[i].value === vehsegids) {
                    vehseg.selectedIndex = i;
                    break;
                }
            }
        ...
        <div class="row" style="padding: 0px 20px;">
            ...
            <div class="col-md-2 col-sm-12 col-xs-12 " style="padding-top: 15px;">
                <div class="form-group fa-pull-right ">
                    <a class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg" onclick="NewUserProfile();">New Vehicle Make</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-content modal-heading">
                    ...
                    <h4 class="modal-title" id="myModelLabel">&nbsp; Vehicle Make</h4>
                </div>
                <div class="modal-body">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <h5 style="color: #2196f3;display:none;">Vehicle Make</h5>
                                    ...
                                    <div class="col-md-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <label>Name</label>
                                              ...
                                              <div class="col-md-6 col-xs-12">
                                            <asp:TextBox runat="server" ID="txtvehmakename" CssClass="form-control form-control1" autocomplete="off"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <label>AC/Non Ac</label>
                                              ...
                                              <div class="col-md-6 col-xs-12">
                                           <asp:DropDownList runat="server" ID="ddlAcNonAc" CssClass="form-control form-control1">
                                    ...
                                    <div class="col-md-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <label >Vehicle Segments</label>
                                              ...
                                              <div class="col-md-6 col-xs-12">
                                             <asp:DropDownList runat="server" ID="ddlVehicles" CssClass="form-control form-control1">
                ...
                <div class="modal-footer" style="margin-top: 140px !important;">
